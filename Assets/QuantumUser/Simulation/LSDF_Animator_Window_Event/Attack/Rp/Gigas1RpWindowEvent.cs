...
[Serializable]
public class Gigas1RpWindowEvent : AnimatorTimeWindowEventAsset
{
    /// <summary>
    /// 시작 프레임
    /// </summary>
    private const int HitFrame = 18;
    ...
    public override unsafe void Execute(Frame f, AnimatorComponent* animatorComponent, LayerData* layerData)
    {
        ...
        //상단회피, 점프 
        if (11 < currentFrame && currentFrame < 22)
        {
            //player->isJump = true;
        ...
        if (currentFrame == HitFrame - 1)//히트 박스 적용 때문에 한 프레임 전에 생성되어야함
        {
            ...
            {
                //위치
                Position = f.Get<Transform2D>(entity).Position + new FPVector2((FP._0_25 + FP._0_03) * flip,  -(FP._0_25 + FP._0_03)),
                Rotation = FP._0
            });
            ...
            f.Add(hitbox, new LSDF_HitboxInfo
            {
                ...
                //카운터 시 상대가 어떻게 되는가
                CountType = CountAttackType.Stun,
