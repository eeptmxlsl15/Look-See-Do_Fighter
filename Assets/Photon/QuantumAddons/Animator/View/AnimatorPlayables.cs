namespace Quantum.Addons.Animator
{
  ...
  public unsafe class AnimatorPlayables : QuantumEntityViewComponent, IAnimatorEntityViewComponent
  {
    private UE.Animator _animator;

    private Dictionary<String, KeyValuePair<int, AnimationClipPlayable>> _clips =
    ...
    private List<int> _activeInputs = new List<int>(64);
    private static List<AnimatorRuntimeBlendData> _blendData = new List<AnimatorRuntimeBlendData>(64);
    private static List<AnimatorMotion> _motionData = new List<AnimatorMotion>(32);
