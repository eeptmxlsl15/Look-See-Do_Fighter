namespace Quantum.Addons.Animator
{
  ...
  public unsafe class AnimatorCondition
  {
    ...
    /// </summary>
    public bool Check(Frame f, AnimatorComponent* animatorComponent, AnimatorGraph graph)
    {
      ...
      switch (variable.Type)
      {
        case AnimatorVariable.VariableType.FP:
          ...
          {
            case Modes.Equals:
              return *AnimatorComponent.Variable(f, animatorComponent, variableIndex)->FPValue == ThresholdFp;
            case Modes.Greater:
              return *AnimatorComponent.Variable(f, animatorComponent, variableIndex)->FPValue > ThresholdFp;
            case Modes.Less:
              return *AnimatorComponent.Variable(f, animatorComponent, variableIndex)->FPValue < ThresholdFp;
        ...
        case AnimatorVariable.VariableType.Int:
          ...
          {
            case Modes.Equals:
              return *AnimatorComponent.Variable(f, animatorComponent, variableIndex)->IntegerValue == ThresholdInt;
            case Modes.Greater:
              return *AnimatorComponent.Variable(f, animatorComponent, variableIndex)->IntegerValue > ThresholdInt;
            case Modes.Less:
              return *AnimatorComponent.Variable(f, animatorComponent, variableIndex)->IntegerValue < ThresholdInt;
        ...
        case AnimatorVariable.VariableType.Bool:
          ...
          {
            case Modes.If:
              return *AnimatorComponent.Variable(f, animatorComponent, variableIndex)->BooleanValue;
            case Modes.IfNot:
              return !*AnimatorComponent.Variable(f, animatorComponent, variableIndex)->BooleanValue;
          }
